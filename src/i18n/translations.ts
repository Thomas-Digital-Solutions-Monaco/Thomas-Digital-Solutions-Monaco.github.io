      ...
      items: [
        {
          ...
          desc: "Native-feeling iOS & Android apps for the App Store and Google Play.",
          detail: "We take mobile products from idea to store listing with React Native and Expo — one codebase, both platforms, without compromising the native feel.",
          points: ["iOS & Android from one codebase", "App Store & Google Play submission", "Offline-first, push & deep links", "Analytics & crash reporting"],
        },
        {
          id: "desktop", title: "Desktop & Cross-Platform",
          desc: "Mac and Windows apps from a shared codebase — consistent everywhere.",
          detail: "Fast, native-feeling Mac and Windows apps that stay in sync with your mobile and web experiences — one design system, everywhere your users are.",
          points: ["macOS & Windows builds", "Auto-updates & code signing", "Shared logic with mobile/web", "Shortcuts & OS integrations"],
        },
        {
          id: "automation", title: "Automation & Integration",
          desc: "Workflows and API integrations that remove repetitive work.",
          detail: "We connect the tools you already use and automate the busywork between them — from device management to custom API integrations that keep data moving.",
          points: ["Custom API & webhook integrations", "Device automation (Intune, scripting)", "Scheduled & event-driven workflows", "Dashboards to monitor it all"],
        },
        {
          id: "cloud", title: "Cloud & DevOps",
          desc: "Azure infrastructure and CI/CD so you ship continuously and safely.",
          detail: "Infrastructure as code, automated pipelines and monitoring — so every release is repeatable, observable and safe to roll back.",
      ...
      items: [
        {
          ...
          desc: "Des apps iOS & Android au rendu natif, pour l'App Store et Google Play.",
          detail: "De l'idée à la mise en ligne avec React Native et Expo — une seule base de code, les deux plateformes, sans sacrifier le rendu natif.",
          points: ["iOS & Android depuis une base de code", "Publication App Store & Google Play", "Offline-first, push & deep links", "Analytics & rapports de crash"],
        },
        {
          id: "desktop", title: "Desktop & multiplateforme",
          desc: "Des apps Mac et Windows depuis une base partagée — cohérentes partout.",
          detail: "Des applications Mac et Windows rapides, au rendu natif, synchronisées avec vos expériences mobiles et web — un seul design system, partout.",
          points: ["Builds macOS & Windows", "Mises à jour auto & signature", "Logique partagée mobile/web", "Raccourcis & intégrations OS"],
        },
        {
          id: "automation", title: "Automatisation & intégration",
          desc: "Workflows et intégrations d'API qui suppriment les tâches répétitives.",
          detail: "Nous relions vos outils et automatisons les tâches entre eux — de la gestion de parc aux intégrations d'API sur mesure qui font circuler vos données.",
          points: ["Intégrations API & webhooks", "Automatisation des postes (Intune)", "Workflows planifiés & événementiels", "Tableaux de bord de supervision"],
        },
        {
          id: "cloud", title: "Cloud & DevOps",
          desc: "Infrastructure Azure et CI/CD pour livrer en continu et en sécurité.",
          detail: "Infrastructure as code, pipelines automatisés et supervision — pour que chaque release soit reproductible, observable et réversible.",
          points: ["Infrastructure Azure as code", "Pipelines CI/CD (GitHub Actions)", "Supervision, logs & alertes", "Déploiements sans interruption"],
        },
      ],
    },
    work: {
