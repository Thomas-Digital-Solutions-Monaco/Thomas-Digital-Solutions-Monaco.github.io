...
export const circuitPath =
  "M 85 178 C 112 108 165 56 236 50 C 292 45 320 122 348 152 C 378 184 420 140 452 122 " +
  "C 496 96 534 102 556 128 C 572 146 560 152 549 148 C 535 143 540 170 557 175 " +
  "C 573 179 565 194 553 203 C 502 230 448 242 388 248 C 312 256 236 252 168 250 " +
  "C 133 249 116 248 108 246 C 90 244 79 229 84 211 C 87 196 74 186 85 178 Z";
