/**
 * Crisp original top-down F1 car (points to +x / right), drawn around origin.
 * Clearer silhouette: wide front wing, narrowing nose, sidepods, rear wing,
 * exposed wheels and a driver halo/helmet — plus white racing accents so the
 * shape reads as a Formula-1 car even at small scale.
 */
const TopDownCar = ({ scale = 1 }: { scale?: number }) => (
  <g transform={`scale(${scale})`}>
    ...
    {/* ── front wing (wide, at the nose) ── */}
    <rect x="12.5" y="-8" width="2.6" height="16" rx="1" fill="#e9e9ef" />
    <rect x="11" y="-8" width="1.6" height="16" rx="0.6" fill="#b9111f" />

    {/* ── rear wing (wide, at the tail) ── */}
    <rect x="-14.5" y="-8.5" width="3" height="17" rx="1" fill="#141319" />
    <rect x="-13" y="-8.5" width="1.4" height="17" rx="0.6" fill="#e9e9ef" />

    {/* ── main body: wide nose → narrow tail ── */}
    <path
      d="M 13 0 L 8 -2.6 L 2 -3.4 L -4 -4.6 L -12 -4 L -13 -2.4 L -13 2.4 L -12 4 L -4 4.6 L 2 3.4 L 8 2.6 Z"
      fill="#d81e2c" stroke="#8f0f1b" strokeWidth="0.7"
    />

    {/* white racing centre stripe */}
    ...
    {/* halo + helmet (cockpit) */}
    <circle cx="-1" cy="0" r="3" fill="#141319" />
    <circle cx="-1" cy="0" r="1.7" fill="#f4f4f8" />
    <circle cx="-1" cy="0" r="0.8" fill="#d81e2c" />
